...
#### ESEMPIO 1 è un AVL?
![Pasted image 20241127154705.png](/img/user/ANNO%202/ALGORITMI%201/fotoalg/Pasted%20image%2020241127154705.png)
...
#### ESEMPIO 2 è un AVL?
![Pasted image 20241127154954.png](/img/user/ANNO%202/ALGORITMI%201/fotoalg/Pasted%20image%2020241127154954.png)
la foglia sarà sempre $0$ ma il nodo 20 ha $\beta=2$ che è $> \ di \ 1$ quindi <font color="#ff0000">non è bilanciato</font>


#### ESEMPIO 3 è un AVL?
![Pasted image 20241127155238.png](/img/user/ANNO%202/ALGORITMI%201/fotoalg/Pasted%20image%2020241127155238.png)
...
##### come è fatto?
![Pasted image 20241127160149.png](/img/user/ANNO%202/ALGORITMI%201/fotoalg/Pasted%20image%2020241127160149.png)
...
![Pasted image 20241127160435.png](/img/user/ANNO%202/ALGORITMI%201/fotoalg/Pasted%20image%2020241127160435.png)
- sono $T_i$ dove $i$ è l'altezza
praticamente possiamo notare che per fare $T_h$ dovremmo porre
- una radice
- a $sx$ $T_{h-1}$
- a $dx$ $T_{h-2}$
![Pasted image 20241127161302.png|280](/img/user/ANNO%202/ALGORITMI%201/fotoalg/Pasted%20image%2020241127161302.png)
...
###### INSERT e DELETE
![Pasted image 20241127164515.png|500](/img/user/ANNO%202/ALGORITMI%201/fotoalg/Pasted%20image%2020241127164515.png)
...
>![Pasted image 20241127171454.png](/img/user/ANNO%202/ALGORITMI%201/fotoalg/Pasted%20image%2020241127171454.png)
>
...
![Pasted image 20241127180648.png](/img/user/ANNO%202/ALGORITMI%201/fotoalg/Pasted%20image%2020241127180648.png)
...
![Pasted image 20241127181613.png](/img/user/ANNO%202/ALGORITMI%201/fotoalg/Pasted%20image%2020241127181613.png)
...
Esempio `insert(10,e)`
![ezgif.com-speed_4 1.gif|600](/img/user/ANNO%202/ALGORITMI%201/fotoalg/ezgif.com-speed_4%201.gif)
##### Costo di insert
...
Esempio `delete(8)`
![slides_animation_slower-ezgif.com-crop.gif](/img/user/ANNO%202/ALGORITMI%201/fotoalg/slides_animation_slower-ezgif.com-crop.gif)
