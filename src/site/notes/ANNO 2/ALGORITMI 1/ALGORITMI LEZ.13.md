...
`insert(e,8)`
![ezgif.com-crop.gif](/img/user/ANNO%202/ALGORITMI%201/fotoalg/ezgif.com-crop.gif)
###### costo: $O(log_dn)$
...
fix dall'alto:
![ezgif.com-speed_8.gif|600](/img/user/ANNO%202/ALGORITMI%201/fotoalg/ezgif.com-speed_8.gif)

fix dal basso:
![ezgif.com-speed_7.gif|600](/img/user/ANNO%202/ALGORITMI%201/fotoalg/ezgif.com-speed_7.gif)
...
![pages_32_to_36_looping-ezgif.com-speed.gif|600](/img/user/ANNO%202/ALGORITMI%201/fotoalg/pages_32_to_36_looping-ezgif.com-speed.gif)
###### costo: $O(log_dn)$
###### incremento chiave
![pages_38_to_42_looping-ezgif.com-speed.gif|600](/img/user/ANNO%202/ALGORITMI%201/fotoalg/pages_38_to_42_looping-ezgif.com-speed.gif)
...
![Pasted image 20241204191336.png](/img/user/ANNO%202/ALGORITMI%201/fotoalg/Pasted%20image%2020241204191336.png)
...
>![Pasted image 20241204191831.png|400](/img/user/ANNO%202/ALGORITMI%201/fotoalg/Pasted%20image%2020241204191831.png)
...
![Pasted image 20241204192625.png](/img/user/ANNO%202/ALGORITMI%201/fotoalg/Pasted%20image%2020241204192625.png)
##### Tutte le procedure 
con una funzione ausiliaria potrò fare tutto
###### Ristruttura
![Pasted image 20241204194335.png](/img/user/ANNO%202/ALGORITMI%201/fotoalg/Pasted%20image%2020241204194335.png)
...
![Pasted image 20241204194459.png](/img/user/ANNO%202/ALGORITMI%201/fotoalg/Pasted%20image%2020241204194459.png)
...
![Pasted image 20241204195300.png|400](/img/user/ANNO%202/ALGORITMI%201/fotoalg/Pasted%20image%2020241204195300.png)

###### Decremento chiave
decrementi e fai muovi in alto del singolo alberello $O(log_n)$ altezza albero
![slides_65_66_slower_looping-ezgif.com-speed.gif|500](/img/user/ANNO%202/ALGORITMI%201/fotoalg/slides_65_66_slower_looping-ezgif.com-speed.gif)
###### Cancellazione 
...
![Pasted image 20241204195337.png|400](/img/user/ANNO%202/ALGORITMI%201/fotoalg/Pasted%20image%2020241204195337.png)
### Heap di Fibonacci
>[!warning] bisogna sapere solo cosa è e quanto costa


inventato da Tarjan esperto di strutture dati
![tarzan-jump.gif](/img/user/ANNO%202/ALGORITMI%201/fotoalg/tarzan-jump.gif)
